  ...
  return (
    <section className="bg-gray-50 py-5">
      <div className="container">
          <h2 className="font-semibold text-[20px] md:text-[30px] mb-3">Great discounts for you!</h2>
            ...
            <div
              ...
              {dealsData.map((deal) => (
                <Link
                    ...
                    <div className="bg-gradient-to-br from-[#4a0a0a] to-[#7d1010] h-36 p-4 flex justify-between relative">
