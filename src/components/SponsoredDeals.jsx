...
export default function SponseredDeals() {
  ...
  return (
    <section className="bg-gray-50 py-5">
      <div className="container">
          <h2 className="font-semibold text-[20px] md:text-[30px] mb-3">Sponsered Deals</h2>
            ...
            <div
              ...
              {dealsData.map((deal) => (
                <Link
                    ...
                    <div className="bg-gradient-to-br from-[#82093a] to-[#be0f58]head h-36 p-4 flex justify-between relative">
